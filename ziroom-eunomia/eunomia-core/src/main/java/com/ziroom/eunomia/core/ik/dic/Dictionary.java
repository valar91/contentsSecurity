 ...
 * 
 */
package com.ziroom.eunomia.core.ik.dic;

import com.ziroom.eunomia.core.ik.config.Configuration;
...
public class Dictionary {
	...
	private void loadMainDict() {
		...
		InputStream is = null;
		try {
			is = new ClassPathResource(cfg.getMainDictionary()).getInputStream();
		} catch (IOException e) {
			e.printStackTrace();
		}
		if(is == null){
